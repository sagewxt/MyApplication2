...
public class Ch4Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //通过界面的容器找到所包含的所有子元素,再来注册监听器
        LinearLayout linearLayout=(LinearLayout)findViewById(R.id.ch4_3_ll);
        int count=linearLayout.getChildCount();//包含几个
        for(int i=0;i<count;i++){
            View view=linearLayout.getChildAt(i);
            if(view instanceof CheckBox){//如果当前对象是CheckBox的一个实例
                CheckBox checkBox=(CheckBox)view;//找到事件源
