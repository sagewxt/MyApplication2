...
public class Ch7Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //实例化适配器
        simpleAdapter=new SimpleAdapter(this,list,R.layout.layout_goods,new String[]{"name","price","img"},new int[]{R.id.goods_name,R.id.goods_price,R.id.goods_img});//上下文，list类型的数据，资源(展示每个商品的界面),显示的数据的名称，整型数组
        //设置到listview
